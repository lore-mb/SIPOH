    ...
    public static class NinjectWebCommon 
    {
        ...
        private static MapperConfiguration CreateConfiguration()
        {
            var config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<Ejecucion, EjecucionDTO>();
                cfg.CreateMap<Expediente, ExpedienteDTO>();
                cfg.CreateMap<DetalleEjecucionModelView, Ejecucion>().ReverseMap();
                ...
                cfg.CreateMap<PromocionModelView, EjecucionPosterior>().ReverseMap();
                cfg.CreateMap<AnexosModelView, Anexo>().ReverseMap();
            });
            return config;
        }
